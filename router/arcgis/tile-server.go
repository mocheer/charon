...
// ReadTile 返回瓦片数据
func (server *TileServer) ReadTile(tile gm.Tile) ([]byte, error) {
...
func (server *TileServer) ReadCompactTile(tile gm.Tile) ([]byte, error) {
...
func (server *TileServer) ReadCompactTileV2(tile gm.Tile) ([]byte, error) {
...
func (server *TileServer) GetFileInfo(tile gm.Tile) (bundlxPath, bundlePath string, imgDataIndex int64) {
...
func (server *TileServer) ReadExplodedTile(tile gm.Tile) ([]byte, error) {
	return os.ReadFile(server.GetFilePath(tile))
}

// GetFilePath 返回图片路径
func (server *TileServer) GetFilePath(tile gm.Tile) string {
